...
const LINUX_PKGS = [
  { has: 'apt-get', cmd: 'sudo apt-get install -y ffmpeg cmake build-essential python3-pip python3-venv libegl1 libgl1 libglib2.0-0' },
  { has: 'dnf', cmd: 'sudo dnf install -y ffmpeg cmake gcc-c++ make python3-pip mesa-libEGL mesa-libGL glib2' },
  { has: 'pacman', cmd: 'sudo pacman -S --needed ffmpeg cmake base-devel python-pip mesa glib2' },
  { has: 'zypper', cmd: 'sudo zypper install -y ffmpeg cmake gcc-c++ make python3-pip Mesa-libEGL1 Mesa-libGL1 glib2' },
];
